...
import image1 from "../../assets/images/products/f1.jpg";
import image2 from "../../assets/images/products/f8.jpg";
import image3 from "../../assets/images/products/f7.jpg";
import image4 from "../../assets/images/products/f5.jpg";
import image5 from "../../assets/images/products/p1.jpg";
import image6 from "../../assets/images/products/p2.jpg";
import image7 from "../../assets/images/products/p6.jpg";
import image8 from "../../assets/images/products/f11.jpg";
        ...
        <Row>
          ...
          <Col className="p-1" lg={3} md={2} sm={6}>
            <div>
              <Card className="image-box card w-100">
                <div className="overflow-hidden w-100">
                  <img className="center w-100" src={image7} alt="Product 1" />
                  <Card.Body>
                    <p className="product-name-on-card">
                      Perfect Homes Webster Engineered Wood TV
                    </p>
          ...
          <Col className="p-1" lg={3} md={2} sm={6}>
            <div>
              <Card className="image-box card w-100">
                <div className="overflow-hidden w-100">
                  <img className="center w-100" src={image8} alt="Product 1" />
                  <Card.Body>
                    <p className="product-name-on-card">
                      Perfect Homes Webster Engineered Wood TV
                    </p>
