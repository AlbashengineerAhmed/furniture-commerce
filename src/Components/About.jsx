  ...
  return (
    <>
      <Container>
        ...
        <Row className="p-2" style={{minHeight:670}}>
          <Col className="shadow-sm bg-white mt-2" md={12} lg={12} sm={12} xs={12}>
            ...
            <p className="section-title-contact">
              ...
              I try to create a project-based course that helps you to learn professionally and make you feel as a complete developer. Creative Team Programming exists to help you succeed in life. Each course has been hand-tailored to teach a specific skill. I hope you agree! Whether you’re trying to learn a new skill from scratch or want to refresh your memory on something you’ve learned in the past, you’ve come to the right place. Education makes the world a better place. Make your world better with new skills.
            </p>
          </Col>
        </Row>
      </Container>
